            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  ...
                  <div className="text-sm text-blue-600">Evidence Archived</div>
                </div>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                  ...
                  <div className="text-sm text-yellow-600">Evidence with Policies</div>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <div className="text-2xl font-bold text-gray-800">{result.documentsWithoutPolicies || 0}</div>
                  <div className="text-sm text-gray-600">Evidence without Policies</div>
                </div>
              </div>
