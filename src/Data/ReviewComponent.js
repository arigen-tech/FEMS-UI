...
const ReviewComponent = ({ setShowReviewReport }) => {
      ...
      <div className="card">
        ...
        <div className="cardLight mb-20">
          <div className='btnBackTop'>
            <button type="button" class="btnBack" onClick={() => setShowReviewReport(false)}></button>
        ...
        <div className="cardLight">
          <h2 className="flex align-center gap-2"><AutoTranslate>Scientific Examination</AutoTranslate></h2>
        ...
        <div class="btn-group">
          ...
          <button type="button" class="btn btn-back" onClick={() => setShowReviewReport(false)}>Back</button>
        </div>
