...
const ForwardingAuthorityDetails = ({ formData = {}, onChange }) => {
  ...
  useEffect(() => {
    ...
    // No State selector in this section, so load the full district list
  ...
  // Which extra fields to show, based on the selected mode's NAME
  // (your master_mode_of_submission rows need "Courier" / "Messenger"
  // somewhere in their name for this branching to work)
