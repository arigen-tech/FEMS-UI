...
const ReportReviewApproved = () => {
    const [referTransfer, setReferTransfer] = useState(false);
    return (
        <>
            <div className="">
                <div className="title">
                    <h1><AutoTranslate>Report Review Approved</AutoTranslate></h1>
                </div>

                <div className="card">
                    <div className="cardLight mb-30">
                        <div className='btnBackTop'>
                            <Link to="/referral-transfer">
                    ...
                    <div className="grid grid-col-4 mb-4">
                        ...
                        <div className="form-group col-span-2">
                            <label><AutoTranslate>Report Review Remarks</AutoTranslate></label>
                            <textarea id="" rows="2" required readOnly></textarea>
                        </div>
                    </div>
...
export default ReportReviewApproved;
