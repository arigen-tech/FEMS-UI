...
const ReferralTransferView = ({ onBack, currentRole }) => {
        ...
        <>
            <div className="card">
                ...
                <div className="grid grid-col-4 mb-4">
                    ...
                    {currentRole === "CASE & EVIDENCE OFFICER" ? (
                        <><div className="form-group">
                            <label><AutoTranslate>Supporting Documents</AutoTranslate></label>
                            <button class="btn btn-view w-100"><MdRemoveRedEye /> <AutoTranslate>View & Download</AutoTranslate></button>
                        </div>
                ...
                <div class="btn-group">
                    {currentRole === "LABORATORY ADMIN / HOD" ? <button type="button" class="btn-primary" onClick={() => { setReferTransfer(true) }}>Refer / Transfer</button> : ""}
                    {currentRole === "CASE & EVIDENCE OFFICER" ? <button type="button" class="btn-primary">Accept</button> : ""}
                            ...
                            <div className="bodyScroller print:overflow-visible print:max-h-none">
                                <div className="mb-4">
                                    <div className="grid grid-col-4 mb-4">
                                        ...
                                        <div className="form-group">
                                            <label><AutoTranslate>City</AutoTranslate></label>
                                            <select>
                                                <option value=""><AutoTranslate>Select</AutoTranslate></option>
                                                <option value=""><AutoTranslate></AutoTranslate></option>
                                            </select>
